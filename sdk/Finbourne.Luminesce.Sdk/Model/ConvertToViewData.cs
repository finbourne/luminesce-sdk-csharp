...
namespace Finbourne.Luminesce.Sdk.Model
{
    ...
    public partial class ConvertToViewData : IEquatable<ConvertToViewData>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.DocumentationLink != null && this.DocumentationLink.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DocumentationLink, length must be less than 256.", new [] { "DocumentationLink" });
            }

            // DocumentationLink (string) minLength
            if (this.DocumentationLink != null && this.DocumentationLink.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DocumentationLink, length must be greater than 0.", new [] { "DocumentationLink" });
            }

...
namespace Finbourne.Luminesce.Sdk.Model
{
    ...
    public partial class IntellisenseItem : IEquatable<IntellisenseItem>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Caption != null && this.Caption.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Caption, length must be greater than 1.", new [] { "Caption" });
            }

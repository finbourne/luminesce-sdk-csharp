...
namespace Finbourne.Luminesce.Sdk.Model
{
    ...
    public partial class MappableField : IEquatable<MappableField>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // SampleValues (string) maxLength
            if (this.SampleValues != null && this.SampleValues.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SampleValues, length must be less than 256.", new [] { "SampleValues" });
            }

            // SampleValues (string) minLength
            if (this.SampleValues != null && this.SampleValues.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SampleValues, length must be greater than 0.", new [] { "SampleValues" });
            }

            // AllowedValues (string) maxLength
            if (this.AllowedValues != null && this.AllowedValues.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AllowedValues, length must be less than 256.", new [] { "AllowedValues" });
            }

            // AllowedValues (string) minLength
            if (this.AllowedValues != null && this.AllowedValues.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AllowedValues, length must be greater than 0.", new [] { "AllowedValues" });
            }

            // MandatoryForActions (string) maxLength
            if (this.MandatoryForActions != null && this.MandatoryForActions.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MandatoryForActions, length must be less than 256.", new [] { "MandatoryForActions" });
            }

            // MandatoryForActions (string) minLength
            if (this.MandatoryForActions != null && this.MandatoryForActions.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MandatoryForActions, length must be greater than 0.", new [] { "MandatoryForActions" });
            }

...
namespace Finbourne.Luminesce.Sdk.Api
{
    ...
    public interface ISqlBackgroundExecutionApiSync : IApiAccessor
    {
        ...
        BackgroundQueryProgressResponse GetProgressOf(string executionId, int operationIndex = 0);
        ...
        ApiResponse<BackgroundQueryProgressResponse> GetProgressOfWithHttpInfo(string executionId, int operationIndex = 0);
        /// <summary>
    ...
    public interface ISqlBackgroundExecutionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BackgroundQueryProgressResponse> GetProgressOfAsync(string executionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BackgroundQueryProgressResponse>> GetProgressOfWithHttpInfoAsync(string executionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// StartQuery: Starts to Execute LuminesceSql in the background.
        /// </summary>
        /// <remarks>
    ...
    public partial class SqlBackgroundExecutionApi : ISqlBackgroundExecutionApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BackgroundQueryProgressResponse</returns>
        public BackgroundQueryProgressResponse GetProgressOf(string executionId, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BackgroundQueryProgressResponse</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<BackgroundQueryProgressResponse> GetProgressOfWithHttpInfo(string executionId, int operationIndex = 0)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BackgroundQueryProgressResponse</returns>
        public async System.Threading.Tasks.Task<BackgroundQueryProgressResponse> GetProgressOfAsync(string executionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<BackgroundQueryProgressResponse> localVarResponse = await GetProgressOfWithHttpInfoAsync(executionId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BackgroundQueryProgressResponse)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<BackgroundQueryProgressResponse>> GetProgressOfWithHttpInfoAsync(string executionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
            {

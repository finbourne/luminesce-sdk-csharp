...
namespace Finbourne.Luminesce.Sdk.Extensions
{
    ...
    public class ApiConfigurationBuilder
    {
        ...
        {
            { "TokenUrl", "tokenUrl" },
            { "BaseUrl", "finbourne-luminesceUrl" },
            { "ClientId", "clientId" },
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-LUMINESCE_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-luminesce_api_url"),
